...
async def generate_session(bot, msg, telethon=False):
    ...
    fukoff = "**{} STRING SESSION** \n\n `{}` \n\nGenerated by @STRING_SESSION_GENERATORBOT".format("TELETHON" if telethon else "PYROGRAM", string_session)
    await client.disconnect()
    await phone_code_msg.reply(fukoff)
